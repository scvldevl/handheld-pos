 ...
 *
 ...
 3. Support for Consumer Devie CVM - enables Visa Mobile Support by setting the Consumer Device CVM (Byte 3, bit 7) to 1 (true) in the VISA TTQ.
 *
 * @retval Result Code:
 * - 00: Successful
 * - 02: Invalid Data Format. One or more packets are invalid.
 ...
 * XPI Reference: E24
 *
 * @retval Result returns an Integer value to indicate the command success
 * - 99: Command Failed/Command Does Not Exist
 * - 0: Command Sucessful
 ...
 */
-(void) Z8:(NSString *)idleMessage1 line2:(NSString*)idleMessage2 line3:(NSString*)idleMessage3 line4:(NSString*)idleMessage4;
/**
 * Set Idle Prompt
 ...
 * XPI Reference: Z8
 */
-(void) setIdlePrompt:(NSString *)idleMessage1 line2:(NSString*)idleMessage2 line3:(NSString*)idleMessage3 line4:(NSString*)idleMessage4;
 ...
 *
 * @retval Result Code: (Each parameter has its own response code, as indicated in the VFIConfigVariable object properties.
 * - 00: Successful, check for data (if any) in the VFIPinpad.configVariables array. This array contains VFIConfigVariable objects which contain the responses for each parameter.
 * - 99: Failure, Command invalid or does not exist
 *
